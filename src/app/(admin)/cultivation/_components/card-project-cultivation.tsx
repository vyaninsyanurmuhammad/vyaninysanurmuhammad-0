      ...
      <div className="group relative flex flex-col gap-6 hover:!opacity-100 group-hover/list:opacity-50 sm:flex-row">
        ...
        <div className="z-10 flex flex-col gap-4">
          <div className="flex flex-col gap-4">
            <div className="relative z-10 h-40 w-full shrink-0 overflow-hidden rounded-lg bg-lime-400"></div>
...
export default CardProjectCultivation;
